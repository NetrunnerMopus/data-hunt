...
namespace view.gui
{
    public class PileCount : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        private Text text;
        ...
        public void UpdateCardCount(Zone zone)
        {
            text.text = zone.Count.ToString();
        }

        public void UpdateBalance(CreditPool credits)
        {
            text.text = credits.Balance.ToString();
        }
