namespace model
{
    ...
    {
        static public Faction ANARCH = new Faction(Side.RUNNER);
        static public Faction CRIMINAL = new Faction(Side.RUNNER);
        static public Faction SHAPER = new Faction(Side.RUNNER);
        ...
        static public Faction WEYLAND_CONSORTIUM = new Faction(Side.CORP);
        static public Faction SHADOW = new Faction(Side.CORP);
    }
}